...
import { testSchema, expectValidationErrorsWithSchema, expectSDLValidationErrors } from './harness.js';
const extensionSDL = `
...
function expectSDLErrors(sdlStr, schema) {
  return expectSDLValidationErrors(schema, UniqueDirectivesPerLocationRule, sdlStr);
}
