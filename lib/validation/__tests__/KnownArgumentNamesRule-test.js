...
import { KnownArgumentNamesRule, KnownArgumentNamesOnDirectivesRule } from '../rules/KnownArgumentNamesRule.js';
...
function expectSDLErrors(sdlStr, schema) {
  return expectSDLValidationErrors(schema, KnownArgumentNamesOnDirectivesRule, sdlStr);
}
