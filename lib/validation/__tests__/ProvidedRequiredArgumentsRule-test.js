...
import { ProvidedRequiredArgumentsRule, ProvidedRequiredArgumentsOnDirectivesRule } from '../rules/ProvidedRequiredArgumentsRule.js';
import { expectValidationErrors, expectSDLValidationErrors } from './harness.js';
...
function expectSDLErrors(sdlStr, schema) {
  return expectSDLValidationErrors(schema, ProvidedRequiredArgumentsOnDirectivesRule, sdlStr);
}
