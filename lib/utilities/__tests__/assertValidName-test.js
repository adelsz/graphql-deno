...
import { assertValidName } from '../assertValidName.js';
describe('assertValidName()', () => {
  ...
  it('throws for use of leading double underscores', () => {
    expect(() => assertValidName('__bad')).to.throw('"__bad" must not begin with "__", which is reserved by GraphQL introspection.');
  });
