...
import { GraphQLScalarType, GraphQLObjectType, GraphQLInterfaceType, GraphQLUnionType, GraphQLEnumType, GraphQLInputObjectType, GraphQLList, GraphQLNonNull } from '../definition.js';
...
describe('Type System: Objects', () => {
  ...
  it('rejects an Object type field with undefined config', () => {
    ...
    expect(() => objType.getFields()).to.throw('SomeObject.f field config must be an object.');
  });
  it('rejects an Object type with incorrectly typed fields', () => {
    ...
    expect(() => objType.getFields()).to.throw('SomeObject fields must be an object with field names as keys or a function which returns such an object.');
  });
  ...
  it('rejects an Object type with incorrectly typed field args', () => {
    ...
    expect(() => objType.getFields()).to.throw('SomeObject.badField args must be an object with argument names as keys.');
  });
  it('rejects an Object type with an isDeprecated instead of deprecationReason on field', () => {
    ...
    expect(() => OldObject.getFields()).to.throw('OldObject.field should provide "deprecationReason" instead of "isDeprecated".');
  });
  it('rejects an Object type with incorrectly typed interfaces', () => {
    ...
    expect(() => objType.getInterfaces()).to.throw('SomeObject interfaces must be an Array or a function which returns an Array.');
  });
  ...
  it('rejects an empty Object field resolver', () => {
    ...
    expect(() => objType.getFields()).to.throw('SomeObject.field field resolver must be a function if provided, but got: {}.');
  });
  it('rejects a constant scalar value resolver', () => {
    ...
    expect(() => objType.getFields()).to.throw('SomeObject.field field resolver must be a function if provided, but got: 0.');
  });
  it('rejects an Object type with an incorrect type for isTypeOf', () => {
    expect(() => new GraphQLObjectType({
      name: 'AnotherObject',
      fields: {},
      // $DisableFlowOnNegativeTest
      isTypeOf: {}
...
describe('Type System: Interfaces', () => {
  it('accepts an Interface type defining resolveType', () => {
    expect(() => new GraphQLInterfaceType({
  ...
  it('rejects an Interface type with incorrectly typed interfaces', () => {
    ...
    expect(() => objType.getInterfaces()).to.throw('AnotherInterface interfaces must be an Array or a function which returns an Array.');
  });
...
describe('Type System: Unions', () => {
  ...
  it('rejects a Union type with incorrectly typed types', () => {
    ...
    expect(() => unionType.getTypes()).to.throw('Must provide Array of types or a function which returns such an array for Union SomeUnion.');
  });
});
describe('Type System: Enums', () => {
  ...
  it('rejects an Enum type without name', () => {
    // $DisableFlowOnNegativeTest
    expect(() => new GraphQLEnumType({
      values: {}
    })).to.throw('Must provide name.');
  });
...
describe('Type System: Input Objects', () => {
  describe('Input Objects must have fields', () => {
    ...
    it('rejects an Input Object type without name', () => {
      // $DisableFlowOnNegativeTest
      expect(() => new GraphQLInputObjectType({})).to.throw('Must provide name.');
    });
    it('rejects an Input Object type with incorrect fields', () => {
      ...
      expect(() => inputObjType.getFields()).to.throw('SomeInputObject fields must be an object with field names as keys or a function which returns such an object.');
    });
  ...
  describe('Input Object fields must not have resolvers', () => {
    it('rejects an Input Object type with resolvers', () => {
      ...
      expect(() => inputObjType.getFields()).to.throw('SomeInputObject.f field has a resolve property, but Input Types cannot define resolvers.');
    });
...
describe('Type System: List', () => {
  ...
  it('rejects a non-type as item type of list', () => {
    // $DisableFlowOnNegativeTest
    expectList({}).to.throw('Expected {} to be a GraphQL type.'); // $DisableFlowOnNegativeTest

    expectList(String).to.throw('Expected [function String] to be a GraphQL type.'); // $DisableFlowOnNegativeTest

    expectList(null).to.throw('Expected null to be a GraphQL type.'); // $DisableFlowOnNegativeTest
...
describe('Type System: Non-Null', () => {
  ...
  it('rejects a non-type as nullable type of non-null', () => {
    // $DisableFlowOnNegativeTest
    expectNonNull(NonNullScalarType).to.throw('Expected Scalar! to be a GraphQL nullable type.'); // $DisableFlowOnNegativeTest

    expectNonNull({}).to.throw('Expected {} to be a GraphQL nullable type.'); // $DisableFlowOnNegativeTest

    expectNonNull(String).to.throw('Expected [function String] to be a GraphQL nullable type.'); // $DisableFlowOnNegativeTest

    expectNonNull(null).to.throw('Expected null to be a GraphQL nullable type.'); // $DisableFlowOnNegativeTest
...
describe('Type System: test utility methods', () => {
  ...
  it('JSON.stringifies types', () => {
    ...
    expect(JSON.stringify(GraphQLList(ListOfScalarsType))).to.equal('"[[Scalar]]"');
  });
