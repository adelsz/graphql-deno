...
import { GraphQLScalarType, GraphQLObjectType, GraphQLInterfaceType, GraphQLUnionType, GraphQLEnumType, GraphQLInputObjectType } from '../definition.js';
const dummyType = new GraphQLScalarType({
  name: 'DummyScalar'
});
...
describe('Type System: Extensions', () => {
  describe('GraphQLScalarType', () => {
    ...
    it('with extensions', () => {
      const scalarExtensions = Object.freeze({
        SomeScalarExt: 'scalar'
      });
      const someScalar = new GraphQLScalarType({
        name: 'SomeScalar',
  ...
  describe('GraphQLObjectType', () => {
    ...
    it('with extensions', () => {
      const objectExtensions = Object.freeze({
        SomeObjectExt: 'object'
      });
      const fieldExtensions = Object.freeze({
        SomeFieldExt: 'field'
      });
      const argExtensions = Object.freeze({
        SomeArgExt: 'arg'
      });
      const someObject = new GraphQLObjectType({
        name: 'SomeObject',
  ...
  describe('GraphQLUnionType', () => {
    ...
    it('with extensions', () => {
      const unionExtensions = Object.freeze({
        SomeUnionExt: 'union'
      });
      const someUnion = new GraphQLUnionType({
        name: 'SomeUnion',
  ...
  describe('GraphQLEnumType', () => {
    ...
    it('with extensions', () => {
      const enumExtensions = Object.freeze({
        SomeEnumExt: 'enum'
      });
      const valueExtensions = Object.freeze({
        SomeValueExt: 'value'
      });
      const someEnum = new GraphQLEnumType({
        name: 'SomeEnum',
