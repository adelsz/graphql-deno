...
import { GraphQLID, GraphQLInt, GraphQLString, GraphQLBoolean } from '../../type/scalars.js';
    ...
    const BlogQuery = new GraphQLObjectType({
      ...
      fields: {
        ...
        feed: {
          ...
          resolve: () => [article(1), article(2), article(3), article(4), article(5), article(6), article(7), article(8), article(9), article(10)]
        }
      }
    });
